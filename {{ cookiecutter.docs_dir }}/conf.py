...
# os.environ['DJANGO_SETTINGS_MODULE'] = '{{ cookiecutter.project_name }}.settings.develop'
# django.setup()
...
copyright = u"%i, {{ cookiecutter.company_name }}" % datetime.date.today().year

pdf_documents = [('index', u'rst2pdf', u'{{ cookiecutter.project_name }}', u'{{ cookiecutter.author }}'), ]

rinoh_documents = [('index',            # top-level file (index.rst)
                    'target',           # output (target.pdf)
                    '{{ cookiecutter.project_name }}',   # document title
                    '{{ cookiecutter.author }}')]   # document author
# rinoh_logo = '_static/logo.png'
rinoh_domain_indices = False

html_context = dict(docs_scope='{{ cookiecutter.scope }}')
